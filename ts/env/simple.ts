...
export function getString(key: string, ...defaultValue: string[]): string {
    const value = process.env[key] || fnString(defaultValue);
    if (value == "") {
...
export function getBoolean(key: string, ...defaults: boolean[]): boolean {
...
export function getArray(key: string, ...defaults: string[][]): string[] {
